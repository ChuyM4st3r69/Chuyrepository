 ...
 */
public class JOptionPaneMensaje extends JDialog {

    public JOptionPaneMensaje(JFrame parent, String nombreCompleto, String nombrePuesto) {
        ...
        JLabel lblPuesto = new JLabel("<html><center>" + nombrePuesto + "</center></html>");
